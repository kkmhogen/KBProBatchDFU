...
public class KBFirmwareDownload {
    ...
    public void downloadFirmwareData(String hexFileName, final DownloadFirmwareDataCallback callback) {
        mHttpDownload.downLoadFile(hexFileName, 60 * 1000, new KBHttpDownload.DownloadCallback() {
            @Override
    ...
    public void downloadFirmwareInfo(String beaconModel, int nMaxDownloadTime, final DownloadFirmwareInfoCallback callback)
    {
        ...
        mHttpDownload.downLoadFile(urlStr, nMaxDownloadTime, new KBHttpDownload.DownloadCallback() {
            @Override
            public void onDownloadComplete(boolean bSuccess, File file, KBException error) {
